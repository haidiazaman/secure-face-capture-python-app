...
def read_image(image, device, target_size, rgb_mean=(104, 117, 123)):
...
def infer(net, image, img_dim, device, cfg, confidence_threshold = None, nms_threshold =None):
    img, img_raw, scale, scale1, resize = read_image(image, device, target_size=img_dim)
    # forward pass
